...
#with open('VQE_Statevector_Kitaev_Square-Octagon_Results/16_Qubit_Statevector_Kitaev_Square_Octagon_1_Layer_HVA_Ground_State_Energies.txt', 'a') as f:
    #f.write(str(optimal_value))
    #f.write('\n')
#with open('VQE_Statevector_Kitaev_Square-Octagon_Results/16_Qubit_Statevector_Kitaev_Square_Octagon_1_Layer_HVA_Optimal_Parameters.txt', 'a') as f:
    #np.savetxt(f, optimal_parameters, newline=" ")
    #f.write('\n')
#with open('VQE_Statevector_Kitaev_Square-Octagon_Results/16_Qubit_Statevector_Kitaev_Square_Octagon_1_Layer_HVA_Cost_Function_Evaluations.txt', 'a') as f:
